...
interface ComparisonHeaderProps {
  ...
  onUpdate: (updates: Partial<PropertyComparison>) => void;
  onDelete: () => void;
  isLoading?: boolean;
}
...
export function ComparisonHeader({ 
  ...
  const [editNotes, setEditNotes] = useState(comparison.notes || '');
    ...
    <div className="bg-white rounded-lg border border-gray-200 p-6">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
        ...
        <div className="flex-1">
          {isEditing ? (
            ...
            <div>
              ...
              {comparison.notes && (
                <p className="mt-2 text-gray-600">{comparison.notes}</p>
              )}
              ...
              <div className="mt-3 flex flex-wrap items-center gap-4 text-sm text-gray-500">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span>{comparison.properties.length} properties</span>
                </div>
                ...
                {comparison.tags.length > 0 && (
                  <div className="flex items-center space-x-1">
                    ...
                    <span>{comparison.tags.length} tags</span>
                  </div>
                )}
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span>{comparison.isPublic ? 'Public' : 'Private'}</span>
                </div>
              </div>
        ...
        <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
          <Button
            onClick={() => onUpdate({ isPublic: !comparison.isPublic })}
            variant="outline"
            disabled={isLoading}
          ...
          >
            ...
            <span>{comparison.isPublic ? 'Make Private' : 'Make Public'}</span>
          </Button>
