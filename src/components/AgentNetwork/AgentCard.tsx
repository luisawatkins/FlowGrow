...
export function AgentCard({ agent, className = '' }: AgentCardProps) {
  ...
  const formatSpecialties = (specialties: string[]) => {
    return specialties.slice(0, 3).map(s => s.replace(/_/g, ' ')).join(', ')
  }
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-shrink-0">
              ...
              />
              {agent.isVerified && (
                <div className="absolute -mt-2 -mr-2 bg-blue-600 rounded-full p-1">
        ...
        <div className="p-6">
          ...
          {agent.specialties.length > 0 && (
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-600">
                {formatSpecialties(agent.specialties)}
                {agent.specialties.length > 3 && ` +${agent.specialties.length - 3} more`}
              </p>
            </div>
          )}
          ...
          {agent.profile.languages.length > 0 && (
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-600">
                {formatLanguages(agent.profile.languages)}
                {agent.profile.languages.length > 2 && ` +${agent.profile.languages.length - 2} more`}
              </p>
            </div>
          )}
